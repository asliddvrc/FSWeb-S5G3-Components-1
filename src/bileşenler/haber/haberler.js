...
const tez = document.querySelector(".articles");
function haberYapici(news) {
  const divElement = document.createElement("div");
  const baslikElement = document.createElement("h2");
  const datElement = document.createElement("p");
  const birElement = document.createElement("p");
  const ikiElement = document.createElement("p");
  const ucElement = document.createElement("p");
  const buttonElement = document.createElement("span");

  divElement.setAttribute("class", "article");
  /* divElement.classList.add("artıcles") */
  datElement.setAttribute("class", "tarih");
  buttonElement.setAttribute("class", "expandButton");
  tez.appendChild(divElement);
  divElement.append(
    baslikElement,
    datElement,
    birElement,
  ...
  baslikElement.textContent = news.baslik;
  datElement.textContent = news.tarih;
  birElement.textContent = news.ilkParagraf;
  ikiElement.textContent = news.ikiElement;
  ucElement.textContent = news.ucuncuParagraf;
...
data.forEach((item) => {
  tez.appendChild(haberYapici(item));
});
